...
import { useSpoonacularData } from "../context/useSpoonacularData.js";
...
export default function RecipePage() {
 ...
 const { recipes, setRecipes, loading, searchRecipes, loadCachedRecipes } = useSpoonacularData();

 useEffect(() => {
   loadCachedRecipes();
 }, []);

 // TODO: save in firebase for logged in user
 ...
 function handleSourceChange(source) {
   ...
   if (source === RECIPE_SOURCE.OFFICIAL) {
     loadCachedRecipes();
   } else {
     // TODO: call user created recipes from firebase
